...
def find_best_three(intervals):
    ...
    for a, b, c in combinations(intervals, 3):
        ...
        ranges = [(a[0], a[1]), (b[0], b[1]), (c[0], c[1])]
        ranges.sort()
...
if uploaded_file:
    try:
        ...
        st.error(f"⚠️ Грешка при обработка: {e}")
